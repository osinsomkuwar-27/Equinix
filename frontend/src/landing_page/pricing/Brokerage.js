  ...
  return (
    <div className="container my-5 mb-5">
      <div className="row text-center mt-5 mb-5">
        <div className="col-6 p-5 text-muted" style={{ textAlign: "left" }}>
          <h3 className="fs-3 mb-4">Charges Explained</h3>
        ...
        <div className="col-6 p-5 mt-5 text-muted" style={{ textAlign: "left" }}>
          <h6>GST</h6>
          <p>
